...
In 2017 and 2018 we tested wheat competitive ability of Australian commercial cultivars and developed high-vigour lines in Condobolin. Because purposely spreading weeds is no option we used non-wheat crops as weed-surrogates and grow them in mixtures.  
To experimentally test if the type of weed influence the competitive ability of our vigorous wheats we grew 2 commercial varieties and seven vigorous lines with six different weed-surrogates testing the effect between wheat genotypes and weed species.  
...
knitr::kable(head(gapminder, n = 5), format = "html", caption = "Overview of entries") %>% 
