...
```{r figure, out.width='100%', fig.align='center', fig.height= 6, fig.width=14, fig.cap="Wheat grain yield of Australian commercial varieties Mace and Scout and developed high-vigour lines W091106, W120206, W120206, W320101, W470201, W670203, W670704 grown in Condobolin without competition (ctrl) or in competition with winter ryegrass (Wr), canola (Ca), tall oat (Bo; Bannister oat), short oat (Mo; Mitika oat), tall barley (Fb; Fathom barley) and short barley (Hb; Hindmarsh barley)."}
...
# Next steps
I'd get really excited by a database to store field data measurements and photos designed by field scientists. Such data base would free me from my own folder system, which in busy times gets chaotic, and further free up space on my computer.
